...
type
  ...
  TSDLTextureWrapper = class
    ...
    constructor Create(aText : String; aFontFile : TFileName; aSize : Integer);
...
constructor TSDLTextureWrapper.Create(aText: String; aFontFile: TFileName;
  aSize: Integer);
var
...
begin
  ...
  aFont:=TTF_OpenFont(PChar(aFontFile),aSize);
  aColor.r:=255;
  aColor.g:=255;
  aColor.b:=0;
  aColor.a:=0;
  aSurface:=TTF_RenderText_Solid(aFont,PChar(aText),aColor);
